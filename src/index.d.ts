...
export type { Action, ActionCreator, AnyAction, Dispatch } from './redux'
...
>(
  ...
  C,
  DistributiveOmit<GetProps<C>, keyof Shared<TInjectedProps, GetProps<C>>> & TNeedsProps
>
...
export function createStore<A>(initialValue: A): Store<A>
